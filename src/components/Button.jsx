...
const Button = ({ name, isBeam = false, containerClass, link, logo}) => {
  if(link){
    ...
    <a
     ...
     className={`flex gap-2 items-center justify-center cursor-pointer p-3 dark:bg-[#393838] transition-all active:scale-95 dark:text-white mx-auto ${containerClass}`}>
    ...
    return (
    <button className={`flex gap-4 items-center justify-center cursor-pointer p-3 dark:bg-[#393838] transition-all active:scale-95 dark:text-white mx-auto ${containerClass}`}>
      {isBeam && (
